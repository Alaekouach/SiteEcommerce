...
<body>
   ...
   <main style="margin-top:150px; margin-bottom:50px">

        <div class="container col-md-11 d-flex justify-content-between pt-5 pb-5 ">

            <div class="col-md-2 border pt-4 bg-light">              

                <a href=" {{ route('siteecommerce.categorie-profil') }} "   style="text-decoration:none">
                    <div class="pl-2  sty" style="height:60px;font-size:1.1rem">
                        <hr>
                        Catégories
                        <hr>
                    </div> 
                ...
                <a href=" {{ route('siteecommerce.souscategorie-profil') }} "   style="text-decoration:none">
                    <div class="pl-2  sty" style="height:60px;font-size:1.1rem">
                        <hr>
                        Sous Catégories
                        <hr>
                ...
                <a href=" {{ route('siteecommerce.product-profil') }} " }} style="text-decoration:none">
                    <div class="pl-2  sty" style="height:60px;font-size:1.1rem">
                        <hr>
                        Produits
                        <hr>
            ...
            <div class="col-md-9  bg-light border">
            ...
            <div class="" style="padding-top:20px">
                <div class="container col-md-8 d-flex " >
                    <div class="text-center text-white col-md-3  ">
                        <h5 class=" mb-5 text-uppercase"><strong > A propos de nous </strong></strong> </h5>
                    ...
                    <div class="text-center text-white col-md-3 ">
                        <h5 class=" mb-5 text-uppercase"><strong > Particuliers </strong></strong> </h5>
                    ...
                    <div class="text-center text-white col-md-3 ">
                        <h5 class=" mb-5 text-uppercase"><strong > Professionnels </strong></strong> </h5>
                    ...
                    <div class=" text-white col-md-3 ">
                        <h5 class="text-center mb-5 text-uppercase"><strong > Nous contacter </strong></strong> </h5>
